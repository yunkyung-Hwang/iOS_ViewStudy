...
class YPImagePickerTest: UIViewController {
    ...
    func showPicker() {
        ...
        config.wordings.libraryTitle = "사진 선택 (\(selectedItems.count)/5)"
        
        config.library.preSelectItemOnMultipleSelection = false
        config.library.minWidthForItem = UIScreen.main.bounds.width * 0.8
        config.library.numberOfItemsInRow = 3
        config.library.spacingBetweenItems = 5
//        config.colors.selectionsBackgroundColor = .red
...
//        config.isScrollToChangeModesEnabled = false
        ...
        //        config.colors.selectionsBackgroundColor = .red
        //        config.colors.tintColor = .black
        //        config.library.collectionview
        //        UINavigationBar.appearance().items?.first?.rightBarButtonItem?.customView?.backgroundColor = .red
...
extension YPImagePickerTest: YPImagePickerDelegate {
